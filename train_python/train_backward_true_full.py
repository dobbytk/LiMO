...
if __name__ == "__main__":
    ...
    ckpt_name = f'ckpt/python_backward/{args.ckpt_name}_best_f1.pt'

    trainer = SupervisedTrainer(datas, classifier, en_labels, id2label, args)
    trainer.writer = SummaryWriter(log_dir=f"runs/python/{args.ckpt_name}")
    ...
    with open(f'./train_python_backward/result/new/experiment_results_{args.ckpt_name}_0927.json', 'w') as file:
